...
import { styleValues } from '../schema/styles.ts'
...
const myStyles = mergeStyles(defaultStyles, styleValues)
const currentSpecSchema = resourceKindStore.currentSchema

console.log('form spec name:', resourceKindStore.activeResourceKind)
console.log('current store schema:', resourceKindStore.currenSchema)
